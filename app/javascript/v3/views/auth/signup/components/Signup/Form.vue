  ...
  computed: {
    ...
    termsLink() {
      return this.$t('REGISTER.TERMS_ACCEPT')
        .replace('https://www.kirvano.com/terms', this.globalConfig.termsURL)
        .replace(
          'https://www.kirvano.com/privacy-policy',
    ...
    showGoogleOAuth() {
      return Boolean(window.kirvanoConfig.googleOAuthClientId);
    },
    isFormValid() {
