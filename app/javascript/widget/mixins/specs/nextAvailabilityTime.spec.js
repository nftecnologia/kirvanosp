...
describe('nextAvailabilityTimeMixin', () => {
  ...
  beforeEach(() => {
    ...
    window.kirvanoWebChannel = kirvanoWebChannel;
  });

  afterEach(() => {
    delete window.kirvanoWebChannel;
  });
  ...
  it('should return channelConfig', () => {
    const wrapper = mount(Component);
    expect(wrapper.vm.channelConfig).toEqual(kirvanoWebChannel);
  });

  it('should return workingHours', () => {
    const wrapper = mount(Component);
    expect(wrapper.vm.workingHours).toEqual(kirvanoWebChannel.workingHours);
  });

  it('should return currentDayWorkingHours', () => {
    const currentDay = new Date().getDay();
    const expectedWorkingHours = kirvanoWebChannel.workingHours.find(
  ...
  it('should return hoursAndMinutesBackInOnline', () => {
    ...
    const currentDayCloseHour =
      kirvanoWebChannel.workingHours[wrapper.vm.currentDay].close_hour;
    const nextDayOpenHour =
      kirvanoWebChannel.workingHours[
  ...
  it('should return in 30 minutes', () => {
    ...
    kirvanoWebChannel.workingHours[4].open_hour = 18;
    kirvanoWebChannel.workingHours[4].open_minutes = 0;
    kirvanoWebChannel.workingHours[4].close_hour = 23;
  ...
  it('should return in 2 hours', () => {
    ...
    kirvanoWebChannel.workingHours[4].open_hour = 19;
  ...
  it('should return at 09:00 AM', () => {
    ...
    kirvanoWebChannel.workingHours[4].open_hour = 10;
  ...
  it('should return tomorrow', () => {
    ...
    kirvanoWebChannel.workingHours[4].open_hour = 9;
    kirvanoWebChannel.workingHours[4].close_hour = 16;
  ...
  it.skip('should return on Saturday', () => {
    ...
    kirvanoWebChannel.workingHours[4].open_hour = 9;
    kirvanoWebChannel.workingHours[4].close_hour = 16;
    kirvanoWebChannel.workingHours[5].closed_all_day = true;
