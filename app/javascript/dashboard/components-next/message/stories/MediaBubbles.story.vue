...
const brokenImageMessage = computed(() =>
  getMessage({
    content: null,
    attachments: [getAttachment('image', 'https://kirvano.dev/broken.png')],
    ...baseSenderData.value,
  })
);
...
const attachmentsOnly = computed(() =>
  getMessage({
    content: null,
    attachments: [
      getAttachment('image', 'https://kirvano.dev/broken.png'),
      getAttachment(
        'video',
        'https://videos.pexels.com/video-files/1739010/1739010-hd_1920_1080_30fps.mp4'
      ),
...
const singleFile = computed(() =>
  getMessage({
    content: null,
    attachments: [getAttachment('file', 'https://kirvano.dev/all-files.tar')],
    ...baseSenderData.value,
  })
);
