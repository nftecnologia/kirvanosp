...
const getMessage = overrides => {
  ...
  return {
    id: 5272,
    content: 'Hey, how are ya, I had a few questions about Kirvano?',
    inboxId: 475,
    conversationId: 43,
    messageType: 0,
    contentType: 'text',
...
const email = computed(() =>
  getMessage({
    ...
    attachments: [
      ...
      getAttachment('file', 'https://kirvano.dev/invoice.pdf'),
      getAttachment('file', 'https://kirvano.dev/logs.txt'),
      getAttachment('file', 'https://kirvano.dev/contacts.xls'),
      getAttachment('file', 'https://kirvano.dev/customers.csv'),
      getAttachment('file', 'https://kirvano.dev/warehousing-policy.docx'),
      getAttachment('file', 'https://kirvano.dev/pitch-deck.ppt'),
      getAttachment('file', 'https://kirvano.dev/all-files.tar'),
      getAttachment(
        'audio',
