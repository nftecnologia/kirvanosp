...
const isOnKirvanoCloud = useMapGetter('globalConfig/isOnKirvanoCloud');
...
const i18nKey = computed(() =>
  isOnKirvanoCloud.value ? 'PAYWALL' : 'ENTERPRISE_PAYWALL'
);
  ...
  <div class="w-full min-h-[12rem] relative">
    ...
    >
      <BasePaywallModal
        ...
        :i18n-key="i18nKey"
        :is-on-kirvano-cloud="isOnKirvanoCloud"
