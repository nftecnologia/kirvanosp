...
import { trimContent, debounce, getRecipients } from '@kirvano/utils';
  ...
  methods: {
    ...
    confirmOnSendReply() {
      ...
      if (!this.showMentions) {
        ...
        // Although Kirvano combines these into a single message, Instagram sends separate echo events for each component.
        // This can create duplicate messages in Kirvano. To prevent this issue, we'll handle text and attachments as separate messages.
