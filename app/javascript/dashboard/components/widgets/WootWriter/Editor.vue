...
import {
  suggestionsPlugin,
  triggerCharacters,
} from '@kirvano/prosemirror-schema/src/mentions/plugin';
...
import { createTypingIndicator } from '@kirvano/utils';
...
<style lang="scss">
@import '@kirvano/prosemirror-schema/src/styles/base.scss';
