export default {
  ...
  DOCS_URL: 'https://www.kirvano.com/docs/product/',
  HELP_CENTER_DOCS_URL:
    'https://www.kirvano.com/docs/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.kirvano.com/content.json',
