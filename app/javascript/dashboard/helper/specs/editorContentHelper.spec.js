...
// the mock of kirvano/prosemirror-schema is getting conflicted with other specs
import { getContentNode } from '../editorHelper';
import {
  MessageMarkdownTransformer,
  messageSchema,
} from '@kirvano/prosemirror-schema';
import { replaceVariablesInMessage } from '@kirvano/utils';

vi.mock('@kirvano/prosemirror-schema', () => ({
  MessageMarkdownTransformer: vi.fn(),
  messageSchema: {},
}));

vi.mock('@kirvano/utils', () => ({
