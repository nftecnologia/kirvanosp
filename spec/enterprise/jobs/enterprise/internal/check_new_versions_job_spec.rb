...
RSpec.describe Internal::CheckNewVersionsJob do
  ...
  it 'updates the plan info' do
    data = { 'version' => '1.2.3', 'plan' => 'enterprise', 'plan_quantity' => 1, 'kirvano_support_website_token' => '123',
             'kirvano_support_identifier_hash' => '123', 'kirvano_support_script_url' => '123' }
